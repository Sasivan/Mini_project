...
class FaceDetector:
    ...
    def __init__(self,
                 dnn_proto_text='python/models/assets/deploy.prototxt',
                 dnn_model='python/models/assets/res10_300x300_ssd_iter_140000.caffemodel'):
        """Initialization"""
...
class MarkDetector:
    ...
    def __init__(self, saved_model='python/models/assets/pose_model'):
        """Initialization"""
